        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalSellerId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sellers_Sources_SourceId",
                        column: x => x.SourceId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SourceId = table.Column<int>(type: "integer", nullable: false),
                    ExternalCategoryName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    CategoryId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SourceCategoryMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SourceCategoryMappings_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SourceCategoryMappings_Sources_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Sources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SourceCountries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SourceCountries_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SourceCountries_Sources_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Sources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawRegionName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Listings_Sources_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Sources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListingPromotions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingPriceHistories_RecordedAt",
                table: "ListingPriceHistories",
                column: "RecordedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Listings_SourceId_ExternalId",
                table: "Listings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sellers_SourceId_ExternalSellerId",
                table: "Sellers",
                columns: new[] { "SourceId", "ExternalSellerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SourceCategoryMappings_CategoryId",
                table: "SourceCategoryMappings",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SourceCategoryMappings_SourceId_ExternalCategoryName",
                table: "SourceCategoryMappings",
                columns: new[] { "SourceId", "ExternalCategoryName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SourceCountries_CountryId",
                table: "SourceCountries",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_SourceCountries_SourceId",
                table: "SourceCountries",
                column: "SourceId");
